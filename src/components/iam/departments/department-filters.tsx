...
import { ActiveFilter, type ListDepartmentsParams } from "@/types/iam/department"
import { CompanyCombobox } from "@/components/iam/company-combobox"
import { DivisionCombobox } from "@/components/iam/division-combobox"

interface Props {
    filters: ListDepartmentsParams
    onFiltersChange: (filters: ListDepartmentsParams) => void
}

export function DepartmentFilters({ filters, onFiltersChange }: Props) {
            ...
            <div className="flex flex-wrap items-center gap-2">
                <div className="w-[200px]">
                    <CompanyCombobox
                        ...
                        onValueChange={(v) => onFiltersChange({ ...filters, companyId: v || undefined, divisionId: undefined, page: 1 })}
                ...
                <div className="w-[200px]">
                    <DivisionCombobox
                        ...
                        onValueChange={(v) => onFiltersChange({ ...filters, divisionId: v || undefined, page: 1 })}
