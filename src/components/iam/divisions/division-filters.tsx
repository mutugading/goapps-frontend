...
import { ActiveFilter, type ListDivisionsParams } from "@/types/iam/division"
import { CompanyCombobox } from "@/components/iam/company-combobox"

interface Props {
    filters: ListDivisionsParams
    onFiltersChange: (filters: ListDivisionsParams) => void
}

export function DivisionFilters({ filters, onFiltersChange }: Props) {
            ...
            <div className="flex flex-wrap items-center gap-2">
                <div className="w-[220px]">
                    <CompanyCombobox
                        ...
                        onValueChange={(v) => onFiltersChange({ ...filters, companyId: v || undefined, page: 1 })}
