...
interface EmployeeGroupFiltersProps {
  filters: ListEmployeeGroupsParams
  onFiltersChange: (filters: ListEmployeeGroupsParams) => void
}

export function EmployeeGroupFilters({
  filters,
  onFiltersChange,
}: EmployeeGroupFiltersProps) {
