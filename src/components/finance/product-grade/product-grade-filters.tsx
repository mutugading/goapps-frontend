...
interface ProductGradeFiltersProps {
  filters: ListProductGradesParams
  onFiltersChange: (filters: ListProductGradesParams) => void
}

export function ProductGradeFilters({ filters, onFiltersChange }: ProductGradeFiltersProps) {
