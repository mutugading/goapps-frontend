...
import { useImportMachines, useDownloadMachineTemplate } from "@/hooks/finance/use-machine"
...
export function MachineImportDialog({
  open,
  onOpenChange,
  onSuccess,
}: MachineImportDialogProps) {
  ...
  const templateMutation = useDownloadMachineTemplate()
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Import machines from an Excel file. Download the template first to
