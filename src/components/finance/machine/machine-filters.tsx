...
import { ActiveFilter, ACTIVE_FILTER_OPTIONS, type ListMachinesParams } from "@/types/finance/machine"
...
export function MachineFilters({ filters, onFiltersChange }: MachineFiltersProps) {
