...
interface InterminglingFiltersProps {
  filters: ListInterminglingsParams
  onFiltersChange: (filters: ListInterminglingsParams) => void
}

export function InterminglingFilters({
  filters,
  onFiltersChange,
}: InterminglingFiltersProps) {
