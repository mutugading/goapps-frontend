...
interface BackendDisable2FAResponse {
    base: {
...
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await fetch(`${backendUrl}/api/v1/iam/auth/2fa/disable`, {
            method: "POST",
            headers: {
        ...
        const data: BackendDisable2FAResponse = await response.json()
