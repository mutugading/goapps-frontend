// IAM Roles routes - List and Create
...
export async function GET(request: NextRequest) {
    try {
        ...
        const isSystemParam = searchParams.get("isSystem") || searchParams.get("is_system")
...
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await client.createRole(body, metadata)
