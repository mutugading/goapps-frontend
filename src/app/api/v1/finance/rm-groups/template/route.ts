// GET /api/v1/finance/rm-groups/template - Download import template
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await client.downloadRMGroupTemplate({}, metadata)
    ...
    console.error("Error downloading RM Group template:", error)
    return NextResponse.json(
      {
        base: {
          isSuccess: false,
