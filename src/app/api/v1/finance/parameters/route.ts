...
export async function GET(request: NextRequest) {
    try {
        ...
        const response = await client.listParameters(
            {
...
// POST /api/v1/finance/parameters - Create Parameter
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await client.createParameter(body, metadata)
