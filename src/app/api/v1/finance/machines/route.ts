        ...
        const response = await client.listMachines(
            {
                ...
                mcTypeFilter: searchParams.get("mcTypeFilter") || searchParams.get("mc_type_filter") || "",
...
// POST /api/v1/finance/machines - Create Machine
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await client.createMachine(body, metadata)
