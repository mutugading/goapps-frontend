// CostCalc — get cost result for product/period/calc-type.
...
export async function GET(
  ...
  try {
    ...
    const response = await client.getCostResult(
      {
    ...
    return NextResponse.json(
      { base: { isSuccess: false, statusCode: "500", message: "Failed to get cost result", validationErrors: [] } },
      { status: 500 },
    )
  }
}
