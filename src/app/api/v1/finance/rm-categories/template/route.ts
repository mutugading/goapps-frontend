// GET /api/v1/finance/rm-categories/template - Download import template
...
export async function GET(request: NextRequest) {
    try {
        ...
        const response = await client.downloadRMCategoryTemplate({}, metadata)
        ...
        console.error("Error downloading RM Category template:", error)
        return NextResponse.json(
            {
                base: {
                    isSuccess: false,
